      ...
      <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
          ...
          <ul class="metismenu" id="side-menu">
            ...
            <li>
              <a href="http://127.0.0.1/tiger/" target="_blank">
                <i class="fi-air-play"></i><span class="badge badge-danger badge-pill float-right"></span> <span> Visit Website </span>
              </a>
            </li>
            ...
            <li>
              <a href="javascript: void(0);"><i class="far fa-address-card"></i><span>About</span> <span class="menu-arrow"></span></a>
              <ul class="nav-second-level" aria-expanded="false">
                <li><a href="/tiger/about/add-about.php">Add About</a></li>
                <li><a href="/tiger/about/all-about.php">View About</a></li>
              </ul>
            </li>
            ...
            <li>
              <a href="javascript: void(0);"><i class="fi-location-2"></i> <span> Patner logo </span> <span class="menu-arrow"></span></a>
              <ul class="nav-second-level" aria-expanded="false">
                <li><a href="/tiger/patner-logo/add-logo.php">Add logo</a></li>
                <li><a href="/tiger/patner-logo/view-logo.php">View logo</a></li>
              </ul>
            </li>

            <li>
              <a href="javascript: void(0);"><i class="far fa-smile-wink"></i><span> Clients </span> <span class="menu-arrow"></span></a>
              <ul class="nav-second-level" aria-expanded="false">
                <li><a href="/tiger/Clients/add-client.php">Add Clients</a></li>
                <li><a href="/tiger/Clients/view-client.php">view Clients</a></li>

              </ul>
            </li>
            <li>
              <a href="javascript: void(0);"><i class="fa fa-hand-peace-o"></i><span> portfolio </span> <span class="menu-arrow"></span></a>
              <ul class="nav-second-level" aria-expanded="false">
                <li><a href="/tiger/portfolio/add-portfolio.php">Add portfolio</a></li>
                <li><a href="/tiger/portfolio/view-portfolio.php">view portfolio</a></li>
